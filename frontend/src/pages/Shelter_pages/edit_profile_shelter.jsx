            ...
            <main className="mt-0 p-0">
                <div className="container mx-auto p-8">
                    ...
                    <form className="bg-white p-6 rounded shadow-md" onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label htmlFor="name" className="block text-sm font-bold mb-2">Shelter Name:</label>
                ...
                <div class="mb-4">
                    <label for="description" class="block text-sm font-bold mb-2">Shelter Description:</label>
