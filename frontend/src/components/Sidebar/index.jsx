...
const Sidebar = () => {
    ...
    return <>
         <div id="sidebar" className={sidebarClasses}>
          <a href="#" className="flex justify-center items-center sm:hidden pt-12">
            <img src="/src/img/logo.svg" className="mr-3 h-12" alt="PetPal logo" />
          ...
          <div className="relative h-10 w-auto min-w-[100px]">
            <select name="shelter"
              ...
              {filterMeta.shelter && filterMeta.shelter.sort().map((shelter) => ((
